...
export const BoxMensagem = ({
  ...
  const [handleModalReply, openReply] = useContext(VariaveisContext);
  ...
  return (
    <>
            ...
            <ContainerMensagensAtendente $cliente={cliente}>
              ...
              {quoteMens ? (
                ...
                <ContainerRespostaAtendente>
                  ...
                  {quoteMens.includes("data:image/png;base64") ||
                  quoteMens.includes("data:image/jpeg;base64") ? (
              ...
              <ContainerHoraMensagem>
                <HoraMensagemAtendente $cliente={cliente}>
                  {horaMensagem}
                </HoraMensagemAtendente>
              </ContainerHoraMensagem>
      ...
      <Button onClick={handleModalReply}>Responder</Button>
    </>
  );
};
...
const ContainerMensagensAtendente = styled.div`
  ...
  background: ${(props) =>
    props.$cliente === "Cliente"
      ? props.theme.cores.primaria.primaria2
      : props.theme.cores.cinza.cinza6};
...
const NomeAtendente = styled.p`
  ...
  color: ${(props) =>
    props.$cliente === "Cliente"
      ? props.theme.cores.secundaria.branco
      : props.theme.cores.secundaria.preto};
